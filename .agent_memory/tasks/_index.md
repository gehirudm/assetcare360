...
- [TASK008] Inventory Manager dashboard componentization — Extract section components and isolate section APIs/state
...
- [TASK015] Dashboard script bootstrap normalization — Standardize include order, init, and legacy script cleanup
