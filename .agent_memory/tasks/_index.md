...
## In Progress
- [TASK007] Supervisor dashboard componentization — dashboard-overview, asset-status, technicians, and budget extracted with parent bridges; checks/tickets/repair still pending
