...
- [TASK014] Inline events to component events migration — SysAdministration inline handlers removed and parent-script globals reduced; cross-dashboard cleanup still pending
