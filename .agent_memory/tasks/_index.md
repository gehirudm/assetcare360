...
- [TASK012] SysAdministration dashboard componentization — In progress: entrypoint consolidated, overview and user-accounts extracted; remaining sections pending
